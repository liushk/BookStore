            ...
            <div class="collapse navbar-collapse" id="navbarMain">
                <div class="col">
                    <form class="form-row container-nav">
                        <div class="col searchInp"><input class="form-control form-control-sm mr-sm-2" type="text" placeholder="Введите название книги или имя автора..." aria-label="Search"></div>
