...
function bookOut(data){
    ...
    out += '<div class="col-4 cartBookName"><a class="text-secondary" href="singleBookPage.php?idbook=' + data.IDBOOK + '" ><span class="cartBookName">"'+ data.FULLBOOKNAME + '" - ' + data.AUTHORS + '</span></a></div>';
