...
CREATE TABLE SECONDGENRE(
    IDSECONDGENRE INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE ORDERSTATUS(
    ...
    ORDERSTATUSNAME VARCHAR(255) NOT NULL UNIQUE
);
...
INSERT INTO SECONDGENRE(IDGENRE, SECONDGENRENAME) VALUES
    (1, "Проза"),
...
INSERT INTO BOOK(ISBN, BOOKNAME, IDSECONDGENRE, IDPUBLISHER, IMPRINTYEAR, PAGE, ANNOTATION, AGELIMIT, COST, PHOTO) VALUES
...
INSERT INTO BOOK(ISBN, BOOKNAME, IDSECONDGENRE, IDPUBLISHER, WEIGHT, IMPRINTYEAR, PAGE, ANNOTATION, COST, PHOTO) VALUES
...
select a.FIRSTNAME, a.LASTNAME from author a, bookauthor ba where ba.IDBOOK = 2 and a.IDAUTHOR = ba.IDAUTHOR
